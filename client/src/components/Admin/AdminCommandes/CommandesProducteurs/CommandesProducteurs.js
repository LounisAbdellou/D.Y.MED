...
class CommandesProducteurs extends React.Component {
  ...
  componentDidMount() {
    ...
    axios.get("https://aws.dymed-back-server.dev/commandeProd").then((data) => {
  ...
  onDelete(e) {
    ...
    axios.post("https://aws.dymed-back-server.dev/commandeProd/delete/" + e.target.attributes.value.value).then((res) => {
