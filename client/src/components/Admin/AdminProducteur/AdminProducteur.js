...
class AdminProducteur extends React.Component {
  ...
  onDelete(e) {
    ...
    axios.post("https://aws.dymed-back-server.dev/producteurs/delete/"+ e.target.attributes.value.value).then((res) => {
  ...
  sendData() {
    ...
    axios.post("https://aws.dymed-back-server.dev/producteurs/store", data).then((res) => {
