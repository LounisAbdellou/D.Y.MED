...
class AdminProducteur extends React.Component {
  ...
  onDelete(e) {
    ...
    axios.post("http://ec2-18-218-191-39.us-east-2.compute.amazonaws.com/producteurs/delete/"+ e.target.attributes.value.value).then((res) => {
  ...
  sendData() {
    ...
    axios.post("http://ec2-18-218-191-39.us-east-2.compute.amazonaws.com/producteurs/store", data).then((res) => {
