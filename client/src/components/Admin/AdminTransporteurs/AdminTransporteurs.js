...
class AdminTransporteurs extends React.Component {
  ...
  componentDidMount() {
    axios.get("https://aws.dymed-back-server.dev/transporteurs").then((data) => {
      console.log(data);
  ...
  onDelete(e) {
    ...
    axios.post("https://aws.dymed-back-server.dev/transporteurs/delete/"+ e.target.attributes.value.value).then((res) => {
  ...
  sendData() {
    ...
    axios.post("https://aws.dymed-back-server.dev/transporteurs/store", data).then((res) => {
