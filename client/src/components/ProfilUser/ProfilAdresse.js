...
function ProfilAdresse() {
    ...
    function onSubmit(e) {
        ...
        if (!errorPrenom && !errorNom && !errorAdress && !errorVille && !errorPostal && !errorPays) {
            if (noAdresse) {
                ...
                axios.post("https://aws.dymed-back-server.dev/adresses/update/" + idAdresse, data).then(res => {
                    console.log(res);
                    window.location.reload();
                }).catch(error => {
                    console.log(error);
    ...
    function deleteAdresse() {
        axios.post("https://aws.dymed-back-server.dev/adresses/delete/" + idAdresse).then(res => {
            console.log(res);
            window.location.reload();
        }).catch(error => {
            console.log(error);
